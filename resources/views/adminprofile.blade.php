<head>
    ...
    <title>AutoWorks - Личный кабинет</title>
</head>
@extends('layouts.app')
@section('content')
                    ...
                    <div class="container">
                        ...
                        <div class="bd-example">
                            <table class="table table-sm table-bordered">
                                <thead>
                                    <tr>
                                        <th scope="col">Логин <br> пользователя</th>
                                        <th scope="col">Электронная <br> Почта</th>
                                        <th scope="col">Удаление <br> аккаунта</th>
                                        <th scope="col">Редактирование <br> данных</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($users as $u)
                                        <tr>
                                            <td>{{ $u->name }}</td>
                                            <td>{{ $u->email }}</td>
                                            <td><a class="btn btn-outline-dark me-2"
                                                    href='delete/{{ $u->id }}'>Удалить</a></td>
                                            <td><a class="btn btn-outline-dark me-2"
                                                    href='edit/{{ $u->id }}'>Редактировать</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
